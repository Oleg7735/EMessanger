...
namespace EncryptMessanger.dll.Tests
{
    ...
    class MesssageSendibleDataTest
    {
        ...
        public void  MessageSendibleDataConvertionTest()
        {
            ...
            MessageSendibleInfo info = new MessageSendibleInfo(53, 15, 946, new DateTime(2017, 4, 14), text, true);
            info.Signature = sign;
            ...
            Assert.That(enotherInfo.AuthorId == info.AuthorId && enotherInfo.DialogId == info.DialogId &&
                ...
                enotherInfo.Signature.SequenceEqual(info.Signature) && enotherInfo.Encrypted == info.Encrypted
                && enotherInfo.Signed == info.Signed);
        }
    }
}
