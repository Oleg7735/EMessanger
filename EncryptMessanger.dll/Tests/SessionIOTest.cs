...
namespace EncryptMessanger.dll.Tests
{
    ...
    public class SessionIOTest
    {
        ...
        public void SaveLoadTest()
        {
            ...
            io.Save(@"C:\Users\home\Documents\Visual Studio 2015\Projects\EncryptMessangerClient\EncryptMessangerClient\bin\Debug\keysTest.test", 76, session);
            ClientClientEncryptedSession sessionTest = io.LoadSession(4245,76, @"C:\Users\home\Documents\Visual Studio 2015\Projects\EncryptMessangerClient\EncryptMessangerClient\bin\Debug\keysTest.test");
            ...
            Assert.That(dialogIdEquals && IVEquals && KeyEquals && rsaSignEquals && rsaToVerifyEquals1 && rsaToVerifyEquals2 && 
                session.VerificationData[0].UserID == sessionTest.VerificationData[0].UserID && session.VerificationData[1].UserID == sessionTest.VerificationData[1].UserID);
        ...
        public void ResaveLoadTest()
        {
            ...
            io.Save(@"C:\Users\home\Documents\Visual Studio 2015\Projects\EncryptMessangerClient\EncryptMessangerClient\bin\Debug\keysTest.test", 76, changedSession);

            ClientClientEncryptedSession sessionTest = io.LoadSession(4218, 76, @"C:\Users\home\Documents\Visual Studio 2015\Projects\EncryptMessangerClient\EncryptMessangerClient\bin\Debug\keysTest.test");
            bool dialogIdEquals = sessionTest.Dialog == session.Dialog;
            ...
            Assert.That(dialogIdEquals && IVEquals && KeyEquals && rsaSignEquals && rsaToVerifyEquals1 &&
                rsaToVerifyEquals2 && session.VerificationData[0].UserID == sessionTest.VerificationData[0].UserID && session.VerificationData[1].UserID == sessionTest.VerificationData[1].UserID);
        }
    }
}
